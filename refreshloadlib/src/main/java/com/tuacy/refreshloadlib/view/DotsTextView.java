...
public class DotsTextView extends TextView {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (attrs != null) {
			...
			jumpHeight = typedArray.getInt(R.styleable.WaitingDots_jumpHeight, (int) (getTextSize() / 2));
		...
		mAnimatorSet.playTogether(dotOneJumpAnimator, createDotJumpAnimator(dotTwo, period / 6),
